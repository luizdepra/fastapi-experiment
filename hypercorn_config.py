...
use_ssl = os.getenv("USE_SSL", "False").lower() in ("yes", "y", "1", "true")
use_tcp = os.getenv("USE_TCP", "True").lower() in ("yes", "y", "1", "true")
...
print("Hypercorn Config: %s" % json.dumps(conf_data, indent=4), flush=True)
